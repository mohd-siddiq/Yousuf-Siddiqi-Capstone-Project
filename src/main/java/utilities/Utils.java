...
public class Utils extends Base {
	...
	public static void clickOnReviewRadioButton(WebElement element) {
		try {
	...
	public static void userClickOnAboutUsCheckBox(WebElement element) {
		try {
			if (element.isDisplayed() == true && element.isEnabled() == true && element.isSelected() == false) {
				element.click();
			} else {
	...
	public static void userClickOnDropDown(WebElement element) {
		try {
			if (element.isDisplayed() == true && element.isEnabled() == true && element.isSelected() == false) {
				element.click();
			} else {
	...
	public static void TakesScreenshotForEachStep() {
		final byte[] screenshot = ((TakesScreenshot) driver).getScreenshotAs(OutputType.BYTES);
		verify.attach(screenshot, "image/png", "Steps Screenshots");
	}
